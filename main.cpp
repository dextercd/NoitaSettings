...
template<>
std::uint32_t read_be<std::uint32_t>(const void* ptr)
{
...
template<>
std::uint32_t read_le<std::uint32_t>(const void* ptr)
{
    auto it = reinterpret_cast<const std::uint8_t*>(ptr);
    return
          (std::uint32_t)it[0] << 0
...
template<>
std::uint64_t read_be<std::uint64_t>(const void* ptr)
{
    auto it = reinterpret_cast<const std::uint8_t*>(ptr);
    return
          (std::uint64_t)it[7] << 0
...
template<>
std::uint64_t read_le<std::uint64_t>(const void* ptr)
{
    auto it = reinterpret_cast<const std::uint8_t*>(ptr);
    return
          (std::uint64_t)it[0] << 0
